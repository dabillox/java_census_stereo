...
public class ModifiedCensusStereoFreiChen {
    ...
    public static void main(String[] args) {
        ...
        KernelJAI kernH = new KernelJAI(3,3,freichen_h_data);
        KernelJAI kernV = new KernelJAI(3,3,freichen_v_data);
        ...
        nadirPB.add(kernH);
        nadirPB.add(kernV);
        RenderedOp NadirFreiChen = JAI.create( "gradientmagnitude", nadirPB);
        ...
        forwardPB.add(kernH);
        forwardPB.add(kernV);
        RenderedOp ForwardFreiChen = JAI.create( "gradientmagnitude", forwardPB);
        
        Raster NadirSobelRaster = NadirFreiChen.getData();
        Raster ForwardSobelRaster = ForwardFreiChen.getData();
        
        //save an image of the gradienti mages for testing purposes   
        File nadirSobelFile = new File("nadirFrei.png");
        try {
            ImageIO.write(NadirFreiChen, "png", nadirSobelFile);
        } catch (IOException e) {
            e.printStackTrace();
        }
        
        File forwardSobelFile = new File("forwardFrei.png");
        try {
            ImageIO.write(ForwardFreiChen, "png", forwardSobelFile);
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        //box filter average
        blur(nadirInPixels, outPixels, imageWidth, imageHeight, smoothingRadius);
        blur(outPixels, smoothedNadirPixels, imageHeight, imageWidth, smoothingRadius);
        blur(forwardInPixels, outPixels, imageWidth, imageHeight, smoothingRadius);
        blur(outPixels, smoothedForwardPixels, imageHeight, imageWidth, smoothingRadius);
        blur(sobelNadirInPixels, outPixels, imageWidth, imageHeight, smoothingRadius);
        blur(outPixels, smoothedSobelNadirPixels, imageHeight, imageWidth, smoothingRadius);
        blur(sobelForwardInPixels, outPixels, imageWidth, imageHeight, smoothingRadius);
        blur(outPixels, smoothedSobelForwardPixels, imageHeight, imageWidth, smoothingRadius);
