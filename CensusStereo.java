...
public class CensusStereo {
    ...
    public static void main(String[] args) {
        ...
        int windowWidth = 9;
        int windowHeight = 9;
        int nBitNumbers = (windowWidth * windowHeight / 8) + 1;
        ...
        NadirCensusMap = CensusImage(nadirArray, imageWidth, imageHeight, windowWidth, windowHeight); 
        ForwardCensusMap = CensusImage(forwardArray, imageWidth, imageHeight, windowWidth, windowHeight);
        ...
        //MedianFilter(yDisArray, smoothedYDisArray, minWidth, maxWidth, minHeight, maxHeight, 5, 0.4);
    ...
    public static int[][][] CensusImage(int[][] inputImage, int width, int height, int winWidth, int winHeight) {
        ...
        int[][][] census = new int[width][height][depth];
